...
const About2 = () => {
      ...
      <div className="container mx-auto pb-20 pt-[100px]">
        ...
        <Tabs className="flex flex-col xl:flex-row gap-6">
          <TabList className="flex flex-row sm:flex-col w-full sm:max-w-[300px] lg:max-w-[380px] mx-auto xl:mx-0 gap-4">
            <Tab className="text-white hover:bg-emerald-400 hover:text-gray-700 font-bold font-mono rounded-md pb-1 pt-1 bg-white/10 text-center">Experience</Tab>
            <Tab className="text-white hover:bg-emerald-400 hover:text-gray-700 font-bold font-mono rounded-md pb-1 pt-1 bg-white/10 text-center">Education</Tab>
            <Tab className="text-white hover:bg-emerald-400 hover:text-gray-700 font-bold font-mono rounded-md pb-1 pt-1 bg-white/10 text-center">Skills</Tab>
            <Tab className="text-white hover:bg-emerald-400 hover:text-gray-700 font-bold font-mono rounded-md pb-1 pt-1 bg-white/10 text-center">About me</Tab>
          </TabList>

          <div className='min-h-[70vh] w-full'>
            {/* Experience Tab Panel */}
            <TabPanel>
              <div className="border border-white/20 rounded-lg p-4 shadow-md bg-white/5">
  ...
  {experience.items.map((item, index) => (
    <li
      key={index}
      className="bg-white/10 p-4 rounded-lg text-white shadow-lg hover:bg-emerald-400 hover:text-gray-800 transition-colors"
    >
  ...
  {skills.items.map((skill, index) => (
    <li
      key={index}
      className="bg-white/10 p-4 rounded-lg text-white shadow-lg hover:bg-emerald-400 hover:text-gray-800 transition-colors text-center"
    >
      {skill}
    </li>
  ))}
